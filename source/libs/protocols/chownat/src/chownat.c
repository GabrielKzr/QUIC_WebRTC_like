...
static int chownat_disconnect_send(const udp_conn_t* conn) {
...
static udp_conn_status_t chownat_udp_recv(const udp_conn_t* conn) {
...
static udp_conn_status_t chownat_tcp_bind(const udp_conn_t* conn) {
